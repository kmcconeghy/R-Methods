...
```{r testdataHomo, include=T}
 ...
  ggplot( aes(x=x, y=y)) +     
    ...
    theme_bw()
```  
**Figure 1.** Example of homoskedascity

```{r testdataHetero, include=T
  y[70:100] <- x + rnorm(0,100) #observations 70-100, set to have a different sigma than 1:69
  ...
  ggplot( aes(x=x, y=y)) + 
    ...
    theme_bw()
```
**Figure 2.** Example of heteroskedascity, variance is greater in X>=69
