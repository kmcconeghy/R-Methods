...
```{r funcWhite, echo=F}
hc <- coeftest(m1, vcovHC(m1, type="HC0")) #Standard
se_results[4,3] <- hc[2,1]
se_results[4,4] <- hc[2,2]
se_results[4,5] <- hc[3,1]
se_results[4,6] <- hc[3,2]

hc <- coeftest(m1, vcovHC(m1, type="HC1")) #Standard
se_results[5,3] <- hc[2,1]
se_results[5,4] <- hc[2,2]
se_results[5,5] <- hc[3,1]
se_results[5,6] <- hc[3,2]

hc <- coeftest(m1, vcovHC(m1, type="HC2")) #Standard
se_results[6,3] <- hc[2,1]
se_results[6,4] <- hc[2,2]
se_results[6,5] <- hc[3,1]
se_results[6,6] <- hc[3,2]

hc <- coeftest(m1, vcovHC(m1, type="HC3")) #Standard
se_results[7,3] <- hc[2,1]
se_results[7,4] <- hc[2,2]
se_results[7,5] <- hc[3,1]
se_results[7,6] <- hc[3,2]

hc <- coeftest(m1, vcovHC(m1, type="HC4")) #Standard
se_results[8,3] <- hc[2,1]
se_results[8,4] <- hc[2,2]
se_results[8,5] <- hc[3,1]
se_results[8,6] <- hc[3,2]
kable(se_results, align=c('c'), digits=3)  
```
